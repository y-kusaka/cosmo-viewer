...
if __name__ == '__main__':
    ...
    # for testing
    arg_str = '--target surf'\
            ' --inpath ../profiles/GAUSSIAN09_TEST/ETHANOL.cosmo'\
            ' --outpath GAUSSIAN_ETHANOL_COSMO.ply'
    args = parser.parse_args(arg_str.split(' '))    
    ...
    # for testing
    arg_str = '--target surf'\
            ' --inpath ../profiles/DMol3_TEST/LFQCEHFDDXELDD-UHFFFAOYSA-N.cosmo'\
            ' --outpath DMol3_Tetramethyl_silicate_COSMO.ply'
    args = parser.parse_args(arg_str.split(' '))    
